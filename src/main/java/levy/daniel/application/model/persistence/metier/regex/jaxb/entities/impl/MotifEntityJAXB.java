...
public class MotifEntityJAXB implements IMotif {
	...
	private static final Log LOG 
		= LogFactory.getLog(MotifEntityJAXB.class);
	...
	public final boolean equals(
		...
		if (!(pObject instanceof MotifEntityJAXB)) {
			return false;
		}
		
		final MotifEntityJAXB other = (MotifEntityJAXB) pObject;
	 ...
	 */
	@Override
	public final MotifEntityJAXB clone() throws CloneNotSupportedException {
		
		final MotifEntityJAXB motifClone = (MotifEntityJAXB) super.clone();
	 ...
	 * {@inheritDoc}
	 */
	@XmlElement(name = "motifJavaScript")
	@Override
...
} // FIN DE LA CLASSE MotifEntityJAXB.---------------------------------------
